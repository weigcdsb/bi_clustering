# -*- coding: utf-8 -*-
"""
Created on Fri Dec  8 12:49:08 2023
...
## write...
with open('Poi_pixel_t_fit1.pkl', 'wb') as f: pickle.dump(t_fit, f)
with open('Poi_pixel_Z_fit1.pkl', 'wb') as f: pickle.dump(Z_fit, f)
with open('Poi_pixel_states_fit1.pkl', 'wb') as f: pickle.dump(states_fit, f)
with open('Poi_pixel_muX_fit1.pkl', 'wb') as f: pickle.dump(muX_fit, f)
